...
CREATE TABLE ACCOUNT_STRUCT (product_id VARCHAR2(100) PRIMARY KEY CHECK (REGEXP_LIKE(product_id, '^PROD[0-9]+')), name VARCHAR2(100) CHECK (type IN ('Savings', 'Withdrawal', 'Deposit')), category VARCHAR2(100), structure VARCHAR2(3))
--
