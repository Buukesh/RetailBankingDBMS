...
CREATE TABLE ACCOUNT_STRUCT (product_id VARCHAR2(100) PRIMARY KEY CHECK (REGEXP_LIKE(product_id, '^PROD[0-9]+')), name VARCHAR2(100), category VARCHAR2(100), structure VARCHAR2(3) CHECK (REGEXP_LIKE(account_id, '^xx[0-9]+'))
--
